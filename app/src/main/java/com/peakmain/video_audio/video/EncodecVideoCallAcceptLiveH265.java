 ...
 * describe：
 */
public class EncodecVideoCallAcceptLiveH265 {
    private SocketAcceptLive socketLive;
    ...
    int frameIndex;
    public EncodecVideoCallAcceptLiveH265(SocketAcceptLive.SocketCallback socketCallback, int width, int height) {
        this.socketLive = new SocketAcceptLive(socketCallback);
        socketLive.start();
        this.width = width;
        this.height = height;
