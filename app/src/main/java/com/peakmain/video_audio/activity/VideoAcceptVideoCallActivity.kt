...
import kotlinx.android.synthetic.main.activity_accept_video_call.*
 ...
 * describe：
 */
class VideoAcceptVideoCallActivity : BaseActivity(), SocketAcceptLive.SocketCallback {
    ...
    fun connect(view: View) {
        videoCallAcceptSurfaceView.startCaptrue (this)
    }
